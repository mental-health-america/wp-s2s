...
<div class="wrap normal clearfix pt-4">
    ...
    <div id="filters-container">
        ...
        <div class="inner">
            ...
            <button id="filter-toggle" class="bold text-gray caps accordion-button mb-5 mb-md-4" type="button" data-toggle="collapse" data-target="#diy-filter" aria-expanded="false" aria-controls="diy-filter" data-expanded-md="true">Filters</button>

            <div id="diy-filter" class="search-filters form-container collapse show-md">

                <a href="/treatment" class="right plain pt-1 small bold">Clear All</a>

...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <div class="wrap medium">
        ...
        <div class="inner">	
            ...
            <div class="inner">
            <form method="GET" action="<?php echo esc_url( $page_permalink ); ?>#ac" class="form-container line-form blue">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-2 mt-3 mt-md-0 pl-1 pr-1">								
                        <div class="dropdown text-right pr-0">
                            ...
                            <div class="dropdown-menu" aria-labelledby="orderSelection">
                                <a href="<?php echo esc_url( add_query_arg( array_merge( $qv, array( 'order' => 'ASC', 'orderby' => 'title' ) ), $page_permalink ) ); ?>#content" class="dropdown-item normal-case archive-filter-order" type="button" data-order="" value="">Default</a>
                                <a href="<?php echo esc_url( add_query_arg( array_merge( $qv, array( 'order' => 'ASC', 'orderby' => 'title' ) ), $page_permalink ) ); ?>#content" class="dropdown-item normal-case archive-filter-order" type="button" data-order="ASC" value="title">A-Z</a>
                                <a href="<?php echo esc_url( add_query_arg( array_merge( $qv, array( 'order' => 'DESC', 'orderby' => 'title' ) ), $page_permalink ) ); ?>#content" class="dropdown-item normal-case archive-filter-order" type="button" data-order="DESC" value="title">Z-A</a>
                                <a href="<?php echo esc_url( add_query_arg( array_merge( $qv, array( 'order' => 'DESC', 'orderby' => 'date' ) ), $page_permalink ) ); ?>#content" class="dropdown-item normal-case archive-filter-order" type="button" data-order="DESC" value="date">Newest</a>
                                <a href="<?php echo esc_url( add_query_arg( array_merge( $qv, array( 'order' => 'ASC', 'orderby' => 'date' ) ), $page_permalink ) ); ?>#content" class="dropdown-item normal-case archive-filter-order" type="button" data-order="ASC" value="date">Oldest</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-2 mt-3 mt-md-0 pl-1 pr-1">								
                        <div class="dropdown text-right pr-0">
                            ...
                            <a href="<?php echo esc_url( add_query_arg( array_merge( $qv, array( 'search_tag' => '', 'search_tax' => '', 'order' => 'ASC', 'orderby' => 'title' ) ), $page_permalink ) ); ?>#content" class="dropdown-item normal-case archive-filter-order" type="button" data-order="" value="">None</a>
                                ...
                                <?php
                                    ...
                                    if ( ! empty( $learn_filter_terms ) && ! is_wp_error( $learn_filter_terms ) ) {
                                        ...
                                        foreach ( $learn_filter_terms as $term ) {
                                            ...
                                            ?>
                                                <a href="<?php echo esc_url( add_query_arg( array_merge( $qv, array( 'search_tag' => $term->term_id, 'search_tax' => $term->taxonomy, 'order' => 'ASC', 'orderby' => 'title' ) ), $page_permalink ) ); ?>#content" class="dropdown-item normal-case archive-filter-order" type="button"><?php echo esc_html( $term->name ); ?></a>
                                            <?php
                                            }
                                        }
                                    }

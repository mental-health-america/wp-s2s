...
/**
 * Feature toggle class on the Gravity Form (Form Settings → CSS Class Name).
 */
define( 'MHA_TRP_GF_FEATURE_CLASS', 'trp-contextual-choices' );
...
function mha_trp_gf_get_form_translation_context( $form_id ) {
	...
	if ( ! mha_trp_gf_css_class_list_has( $form['cssClass'], MHA_TRP_GF_FEATURE_CLASS ) ) {
		$cache[ $form_id ] = null;
		return null;
	}
